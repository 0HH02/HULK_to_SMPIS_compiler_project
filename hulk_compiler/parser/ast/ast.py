...
class ASTNode:
    ...
    def validate(self, visitor: IVisitor, context) -> bool:
        """
        Validates the current instance of the AST node.

        This method can be overridden by subclasses to perform custom validation logic.
        """
